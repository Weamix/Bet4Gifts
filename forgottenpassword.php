              ...
              <html>
                <style>
                 ...
                 <body style="margin: 0; padding: 0; background-color:#2c3e50; font-family: \'Lato\', sans-serif;">
                    ...
                    <div align="center">
                    <br>
                      <a style="background-color: #27ae60; border-radius: 20px; padding: 16px 18px; color: #FFF; text-decoration: none; font-size: 15px; text-transform: uppercase; font-weight: bold;" href="https://bet4gifts.web-edu.fr/confirmation.php?email='.urlencode($email).'&key='.$key.'">Click me !</a>
                    </div>
                    <br><br><br>
                 </body>
              </html>
